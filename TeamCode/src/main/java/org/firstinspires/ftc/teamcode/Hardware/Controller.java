...
public Controller{
    ...
    /* Set automaded values to false because they are recorded in the robot controller
    * This can mess stuff up, so it is best to have them at false so it works cleanly */
